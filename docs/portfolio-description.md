...
**사회적 목표:** 의료영상 분류 과정의 반복 업무를 줄이는 동시에 AI 결과의 신뢰도와 한계를 투명하게 제공하여 의료 AI를 안전하게 활용할 수 있는 환경을 만드는 것을 목표로 한다.

**기술적 목표:** DICOM 처리, 의료영상 딥러닝, FastAPI·React 서비스, MLOps, Human-in-the-loop 및 책임 있는 AI 설계를 하나의 시스템에서 구현한다.

**직업적 목표:** AI 모델 개발에 그치지 않고 데이터 보호, 사용자 경험, 성능 검증과 위험관리까지 고려할 수 있는 의료 AI 소프트웨어 개발자로 성장한다.

**AI 리터러시 적용:** 사용자가 AI의 신뢰도, 오류 가능성, 데이터 편향과 설명 가능성의 한계를 이해하고 최종 결과를 비판적으로 검토할 수 있도록 교육과 투명성 기능을 제공한다.
